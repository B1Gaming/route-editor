...
export default function Select({multi, onChange, options, value}: SelectProps) {
  const [isOpen, setIsOpen] = useState(false);

  function isOptionSelected(option: SelectOption) {
    return multi ? value.map((v) => v.value).includes(option.value) : option.value === value.value;
  }
