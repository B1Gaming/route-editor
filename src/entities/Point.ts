...
export default class Point implements Verifiable {
  flags;
  name;
  unlockedLevels;
  unlockedLevelsSE;
  ...
  public isValid() {
    ...
    return (
        ...
        this.unlockedLevelsSE.filter((ulSe) => !(ulSe.startsWith('W') || verifyPointName(ulSe, options))).length ===
        0 &&
   ...
   * @return this point's values as a valid CSV string
   */
  public toCsvString() {
